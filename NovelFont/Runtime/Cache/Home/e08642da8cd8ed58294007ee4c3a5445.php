...
=======
			<a href="/Novel/index.php/Home/Inspiration/insp_managePage" class="list-group-item  gap" title="Continue">灵感随笔</a>
>>>>>>> origin/master
...
<<<<<<< HEAD
				<a href="/Novel/index.php/Home/NovelPage/novel_add">灵感来了</a>
=======
				<a href="/Novel/index.php/Home/NovelPage/novel_add">新增作品</a>
>>>>>>> origin/master
			</ul>
			<table class="table table-condensed">
				...
				<tr  v-for="item in productList">
					...
					<td><a v-bind:href="'/Novel/index.php/Home/Chapter/toAddPage?branch_id='+item.id">新增章节</a><td>
				</tr>
				</tbody>
			</table>
		</div>
...
=======
<script src="/Novel/NovelFont/Public/js/insp_manage.js"></script>
>>>>>>> origin/master
</body>
</html>