...
<div id="app">
	...
	<div class="row clearfix">
		<div class="col-md-2 column" style="display: inline-block">
			<!--左菜单-->
			<a href="/Novel/index.php/Home/NovelPage/novel_manage" class="list-group-item  gap" title="New_Novel">作品管理</a>
			...
			<table class="table table-condensed">
				...
				<tbody>
					<tr  v-for="item in productList">
						...
						<td><a href="/Novel/index.php/Home/Chapter/toAddPage">新增章节</a><td>
					</tr>
=======
				<a href="#">新增作品</a>
			</ul>
...
<script src="/Novel/NovelFont/Public/js/novel_manage.js"></script>
</body>
</html>